defmodule Au4.Account do
 ...
 def list_users do
  ...
  def reset_user_password(user, attrs) do
    ...
    # 2. Keep this clause for when you only have an email string
    def has_role?(email, role_name) when is_binary(email) do
      case Repo.get_by(User, email: email) |> Repo.preload([:roles, user_apartments: :role]) do
        nil -> false
